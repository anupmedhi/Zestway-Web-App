    ...
    <section id="contact" className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 lg:px-8 relative z-10">
        <motion.div
          ...
          className="relative rounded-[3rem] bg-gradient-to-br from-zest-black via-gray-900 to-zest-black p-10 md:p-16 lg:p-24 text-center shadow-premium overflow-hidden border border-gray-800"
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <motion.div
              ...
              className="inline-block px-6 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm text-zest-yellow font-bold tracking-widest text-sm uppercase mb-8"
            >
              Start Your Journey
            </motion.div>

            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-8 leading-[1.15] tracking-tight">
